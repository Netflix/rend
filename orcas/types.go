...
type Orca interface {
	Set(request common.SetRequest) error
	Add(request common.SetRequest) error
	Replace(request common.SetRequest) error
	Delete(request common.DeleteRequest) error
	Touch(request common.TouchRequest) error
	Get(request common.GetRequest) error
	Gat(request common.GetRequest) error
	Quit(request common.QuitRequest) error
	Version(request common.VersionRequest) error
	Unknown(request common.Request) error
}
